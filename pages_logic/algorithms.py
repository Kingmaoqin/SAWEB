    ...
    with st.expander("🧭 Algorithm Comparison Guide (click to expand)", expanded=False):
        ...
        rows = [
            dict(
                ...
                texgisa = _badge(True,  "MySA/TEXGISA optimizes a survival loss supporting right-censoring."),
